    ...
    function d(e) {
      var t = e.onChange,
        ...
        h = p(
          Object(r.useState)(function() {
            for (var e = [], t = 0; t < v; t++) e.push(t);
            return {
              offset: 0,
              cellContents: e,
              initialAlignmentHasHappened: !1,
            };
          }),
          2
        ),
        y = h[0],
        g = h[1],
        O = p(Object(r.useState)(void 0), 2),
        j = O[0],
        w = O[1],
        ...
        R = p(Object(r.useState)(!1), 2),
        A = R[0],
        L = R[1],
        P = p(Object(r.useState)(!1), 2),
        T = P[0],
        H = P[1],
        U = Object(r.useRef)(!1);
      function D(e) {
      ...
      var M = Object(r.useCallback)(function(e) {
        ...
        z = Object(r.useCallback)(
          function(e) {
            if (m.current) {
              var t = e.code;
              "ArrowUp" === t
                ? $(X(C.current.offset) - 1)
                : "ArrowDown" === t && $(X(C.current.offset) + 1);
            }
          },
          [$, X]
        ),
        ...
        W = Object(r.useCallback)(
          function(e, t) {
            return t[Math.abs(Math.round(e / s)) + 1];
          },
          [s]
        ),
        X = Object(r.useCallback)(
          function(e) {
            return Math.abs(Math.round(e / s)) + 1;
          },
          [s]
        ),
            ...
            g(function(n) {
              return l({}, n, {
                ...
                initialAlignmentHasHappened:
                  !!t || n.initialAlignmentHasHappened,
              });
            });
          },
          [s]
        ...
        F = Object(r.useCallback)(function() {
          ...
          return ((t.bottom + t.top) / 2 - e.top) / (e.bottom - e.top);
        }, []),
              ...
              g(function(n) {
                ...
                return {
                  offset:
                    ...
                    (v % 2 == 1 ? (-1 * s) / 2 : 0),
                  cellContents: [].concat(
                    u(n.cellContents.slice(v / 2, v)),
                    u(n.cellContents.slice(0, v / 2))
                  ),
                  initialAlignmentHasHappened: n.initialAlignmentHasHappened,
                };
              });
          },
          [v, s, F]
      ...
      Object(r.useEffect)(
        ...
        Object(r.useEffect)(
          function() {
            (C.current = y), y.initialAlignmentHasHappened && J(y.offset);
            var e = W(y.offset, y.cellContents);
            E.current !== e && ((E.current = e), t(e));
          },
          [W, J, y, t]
        ),
        Object(r.useEffect)(
      ...
      var G = y.cellContents.map(function(e) {
        return o.a.createElement(
          "div",
          { className: "rdp-cell", key: e },
          c(e)
        );
      });
      return o.a.createElement(
        "div",
        {
          ...
          ref: k,
          role: "slider",
          "aria-valuemax": "hours" === i ? a : 60,
          "aria-valuemin": 0,
          "aria-valuenow": E.current,
          tabIndex: 0,
        },
        o.a.createElement(
          "div",
          { className: "rdp-masked-div" },
          o.a.createElement("hr", {
            className: "rdp-reticule",
            style: { top: s - 1 },
          }),
          o.a.createElement("hr", {
            className: "rdp-reticule",
          ...
          o.a.createElement(
            "div",
            { className: "rdp-text-overlay", style: { top: s } },
            "".concat(c(E.current)),
            o.a.createElement("div", null, n ? i[0] : i)
          ),
          o.a.createElement(
            "div",
            { className: "rdp-column", style: { top: y.offset || 0 }, ref: S },
            G
          )
        )
      );
    ...
    function g(e) {
      var t = e.onChange,
        ...
        d = Object(r.useCallback)(function(e) {
          f(function(t) {
            return v({}, t, { minutes: e });
          });
        }, []),
        m = Object(r.useCallback)(function(e) {
          f(function(t) {
            return v({}, t, { seconds: e });
          });
        }, []);
      return (
